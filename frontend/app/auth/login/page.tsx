...
export default function LoginPage() {
  ...
  return (
    <div className="relative flex items-center justify-center min-h-screen px-4 overflow-hidden bg-black">
      {/* ✨ Crossfade Background tanpa putih-putih */}
      ...
      {/* 🧩 Card Login */}
      <motion.div
        className="bg-white/95 backdrop-blur-md rounded-2xl shadow-2xl p-8 w-full max-w-md relative z-10 border border-white/20"
      ...
      >
        ...
        <form className="space-y-5">
          ...
          <button
            type="submit"
            className="w-full bg-[#E50914] text-white py-3 rounded-lg font-semibold hover:bg-black transition-all duration-300"
          >
            Login
          </button>
        </form>
